...
namespace IMGV::Core
{
    ...
    IMGV_NODISCARD IMGV_API Reference<VertexBuffer> CreateVertexBuffer(UInt32 allocatorSize);
    IMGV_NODISCARD IMGV_API Reference<VertexBuffer> CreateVertexBuffer(VertexBufferData data, UInt32 size);
    IMGV_NODISCARD IMGV_API Reference<IndexBuffer> CreateIndexBuffer(IndexBufferData data, UInt32 count);
}